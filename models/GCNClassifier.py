...
class GCNClassifier(torch.nn.Module):
    ...
    def __init__(self,
                 n_features: int) -> None:
        """
        Set the layers of the Graph Convolutional Network model.
        ...
        # Convolutive layer
        self.conv = GCNConv(in_channels=n_features,
    ...
    def forward_conv(self,
                     ...
                     edge_index: Tensor) -> Tensor:
        """
        Predict new samples embeddings obtained after convolution.
